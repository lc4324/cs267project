...
from hgnn.utils.sampler import get_epoch_samples
from hgnn.utils.dgl_graph import give_one_hot_feats, normalize_edges, edata_in_out_mask, load_link_pred
from hgnn.utils.utils import print_dict, h2dict
from hgnn.utils.evaluator import evaluate, cal_loss_f1
...
def run_HetGNN(model, hg, het_graph, config):
    ...
    from hgnn.utils.sampler import SkipGramBatchSampler, HetGNNCollator, NeighborSampler
